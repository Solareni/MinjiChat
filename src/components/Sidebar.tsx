...
const Sidebar = () => {
	const [sidebars, bottom] = splitArray(
	...
	return (
		<div className="flex h-screen w-12 flex-col items-center bg-background border-r border-border p-2 sm:w-16">
			<div className="w-8 h-8 flex items-center justify-center rounded-full transition-colors mb-8 hover:bg-gray-100/50 dark:hover:bg-gray-800/50">
				<LogoIcon />
			</div>
